...
public class JdbcLectureTest {
    ...
    void checkUpdateLectionTime() {
        ...
        jdbsLectureTime.update(lectureTime);

        assertEquals("2026-02-02 14:30:00", jdbsLectureTime.findById(1L).getStart());
    }
    ...
    void checkFindByIdLectionTime() {
        ...
        assertEquals(jdbsLectureTime.findById(19L), lectureTime);
    }

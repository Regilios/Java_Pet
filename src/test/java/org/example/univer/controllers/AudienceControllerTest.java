...
public class AudienceControllerTest {
    ...
    public void setUp() {
        ...
        AppSettings.RoomSettings roomSettings = new AppSettings.RoomSettings();
        roomSettings.setSizeMin(20);
        roomSettings.setSizeMax(100);

        AppSettings mockAppSettings = new AppSettings();
        mockAppSettings.setRoomSettings(roomSettings);

        ReflectionTestUtils.setField(audienceService, "appSettings", mockAppSettings);
